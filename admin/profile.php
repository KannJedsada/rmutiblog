...
<body>
    <div class="nav-container">
        <div class="logo"><a href="./adminindex.php"><i class="fas fa-backward"></i></a></div>
    </div>
    <div class="carduser">
        <div class="uname">
            <div class="showusername">
                            ...
                            <div id="addModal" class="modaladd">
                                <div class="modal-contentadd">
                                    ...
                                    <form action="changeProfile.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" value="<?php echo $row['profile_img']; ?>" required class="form-control" name="oldimg">
                                        <div class="form-group">
                                            <div style="text-align: center;">
                                                ...
                                                <br><br>
                                                <?php if (!empty($row['profile_img'])) : ?>
                                                    <img id="avatar" src="../img/profile/<?php echo $row['profile_img']; ?>" alt="Profile Image">
                                                <?php else : ?>
                ...
                <div>
                    <button class="btn bg-white " onclick="openModal('editModal_<?php echo $row['user_id']; ?>')">Edit</button>
        ...
        <div class="bodypost">
            <div class="apppost">
                ...
                <button id="myBtn" onclick="openModal('addModal1')">เพิ่มโพสต์ที่นี่</button>
                <!-- The Modal -->
        ...
        ?>
                <div class="card-container">
                    ...
                    <div><a href="#" class="btn"><?php echo $commentCount; ?> comment</a></div>
                </div>
        <?php
            }
        }
