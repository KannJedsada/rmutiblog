...
<body>
    <div class="container pt-5 w-80">
        ...
        <table id="myTable" class="table table-striped">
            ...
            <tbody>
                <?php $count = 1;
                while ($rowuser = $result->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                                ...
                                <div>
                                    ...
                                    <div id="editModal_<?php echo $rowuser['user_id']; ?>" class="modaladd">
                                        <div class="modal-contentadd" style="width: 40%; align-items: center;">
                                            <span class="close" onclick="closeModal('editModal_<?php echo $rowuser['user_id']; ?>')">&times;</span>
                                            <?php
                                            $editProfile = $rowuser['user_id'];
                                    ...
                                    <a href="#" class="text-danger" onclick="confirmDelete('<?php echo $rowuser['user_id']; ?>')">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="currentColor">
